 ...
 *
 * The API never accepts a title — it DERIVES one (`deriveTitle`, in the consuming
 * application's server-side code) so that every client shows the same name for the same
 * document. An editor
