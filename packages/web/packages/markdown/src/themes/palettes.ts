// STANDING palette exception — owner-approved 2026-06-26: the markdown viewer owns its reading-theme palette (--mdv-*), separate from @agenticdevelopertoolkit/themes apt-* tokens. Recorded as a project memory. Do not add raw color outside this file.
//
// This is the ONE module in @agenticdevelopertoolkit/markdown permitted to contain concrete
