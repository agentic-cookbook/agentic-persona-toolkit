...
// Component. See @agenticdevelopertoolkit/markdown's own note on the "use client" propagation trap:
 ...
 * `@agenticdevelopertoolkit/markdown`'s own knowledge about its own palette, so it lives here rather
