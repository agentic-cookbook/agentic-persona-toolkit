...
import { MarkdownRenderer, DEFAULT_THEME_ID, getThemeById } from '@agenticdevelopertoolkit/markdown'
...
/**
 * The markdown PREVIEW BODY (criterion c4): reuses @agenticdevelopertoolkit/markdown's
