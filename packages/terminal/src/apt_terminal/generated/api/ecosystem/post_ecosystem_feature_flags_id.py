...
from ...models.post_ecosystem_feature_flags_id_body import PostEcosystemFeatureFlagsIdBody
...
def _get_kwargs(
    id: str,
    *,
    body: PostEcosystemFeatureFlagsIdBody,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = EcosystemFeatureFlag.from_dict(response.json())
