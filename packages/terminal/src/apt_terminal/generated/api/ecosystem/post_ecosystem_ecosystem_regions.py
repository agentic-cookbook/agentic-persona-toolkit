...
from ...models.post_ecosystem_ecosystem_regions_response_201 import (
...
def _get_kwargs(
    *,
    body: PostEcosystemEcosystemRegionsBody,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[Union[Error, PostEcosystemEcosystemRegionsResponse201]]
    """
...
def sync(
    *,
    ...
    Returns:
        Union[Error, PostEcosystemEcosystemRegionsResponse201]
    """
