...
from ...models.patch_organization_organizations_id_body import PatchOrganizationOrganizationsIdBody
...
def _get_kwargs(
    id: str,
    *,
    body: PatchOrganizationOrganizationsIdBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/organization/organizations/{id}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (PatchOrganizationOrganizationsIdBody): At least one of name, slug, or description is
            required.
