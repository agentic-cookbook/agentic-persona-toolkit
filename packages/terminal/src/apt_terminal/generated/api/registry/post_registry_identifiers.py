...
from ...models.post_registry_identifiers_body import PostRegistryIdentifiersBody
...
def _get_kwargs(
    *,
    body: PostRegistryIdentifiersBody,
) -> dict[str, Any]:
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = RegistryIdentifier.from_dict(response.json())
