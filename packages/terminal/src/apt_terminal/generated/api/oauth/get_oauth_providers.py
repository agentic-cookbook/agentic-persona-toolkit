...
from ...models.get_oauth_providers_response_200_item import GetOauthProvidersResponse200Item
    ...
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = GetOauthProvidersResponse200Item.from_dict(response_200_item_data)
