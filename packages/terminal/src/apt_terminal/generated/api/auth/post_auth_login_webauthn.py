...
from ...models.post_auth_login_webauthn_body import PostAuthLoginWebauthnBody
from ...types import Response


def _get_kwargs(
    *,
    body: PostAuthLoginWebauthnBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/auth/login/webauthn",
    }
...
def sync_detailed(
    *,
    ...
    """Passwordless passkey: verify the assertion → aal=2 session
