...
from ...models.post_customer_refresh_body import PostCustomerRefreshBody
from ...types import Response


def _get_kwargs(
    *,
    body: PostCustomerRefreshBody,
) -> dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Rotate a live customer session (presented refresh token is single-use)
