...
from ...models.patch_project_comments_id_body import PatchProjectCommentsIdBody
...
def _get_kwargs(
    id: str,
    *,
    body: PatchProjectCommentsIdBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/project/comments/{id}",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ProjectComment.from_dict(response.json())
