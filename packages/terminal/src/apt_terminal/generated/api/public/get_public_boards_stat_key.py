...
from ...models.get_public_boards_stat_key_window import GetPublicBoardsStatKeyWindow
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        stat_key (str):
        window (Union[Unset, GetPublicBoardsStatKeyWindow]):  Default:
            GetPublicBoardsStatKeyWindow.TRENDING.
