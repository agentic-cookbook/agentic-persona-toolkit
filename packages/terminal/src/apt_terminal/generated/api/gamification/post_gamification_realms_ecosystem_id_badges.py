...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/gamification/realms/{ecosystem_id}/badges",
    }
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = GamificationRealmBadge.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    """Author a realm badge (admin) — overrides the same (badgeLine, tier) default; POST /replay to
    backfill
