...
T = TypeVar("T", bound="PostUsageUsageEventsResponse201")


@_attrs_define
class PostUsageUsageEventsResponse201:
    """
    Attributes:
        id (int):
        scope (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_usage_usage_events_response_201 = cls(
            id=id,
            scope=scope,
        ...
        return post_usage_usage_events_response_201
