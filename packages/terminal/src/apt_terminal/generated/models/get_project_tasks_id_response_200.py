...
T = TypeVar("T", bound="GetProjectTasksIdResponse200")


@_attrs_define
class GetProjectTasksIdResponse200:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_project_tasks_id_response_200 = cls(
            id=id,
        ...
        return get_project_tasks_id_response_200
