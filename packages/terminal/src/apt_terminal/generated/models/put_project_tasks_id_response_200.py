...
T = TypeVar("T", bound="PutProjectTasksIdResponse200")


@_attrs_define
class PutProjectTasksIdResponse200:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_project_tasks_id_response_200 = cls(
            id=id,
        ...
        return put_project_tasks_id_response_200
