...
T = TypeVar("T", bound="GetUsageRateBucketsScopePrincipalIdResponse200")


@_attrs_define
class GetUsageRateBucketsScopePrincipalIdResponse200:
    """
    Attributes:
        scope (str):
        principal_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_rate_buckets_scope_principal_id_response_200 = cls(
            scope=scope,
        ...
        return get_usage_rate_buckets_scope_principal_id_response_200
