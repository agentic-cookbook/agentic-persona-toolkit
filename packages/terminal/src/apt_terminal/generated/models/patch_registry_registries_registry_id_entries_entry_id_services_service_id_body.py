...
from ..models.patch_registry_registries_registry_id_entries_entry_id_services_service_id_body_delivery_mode import (
    PatchRegistryRegistriesRegistryIdEntriesEntryIdServicesServiceIdBodyDeliveryMode,
)
from ..models.patch_registry_registries_registry_id_entries_entry_id_services_service_id_body_pricing_model import (
    PatchRegistryRegistriesRegistryIdEntriesEntryIdServicesServiceIdBodyPricingModel,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchRegistryRegistriesRegistryIdEntriesEntryIdServicesServiceIdBody")


@_attrs_define
class PatchRegistryRegistriesRegistryIdEntriesEntryIdServicesServiceIdBody:
    """
    Attributes:
        title (Union[Unset, str]):
        description (Union[Unset, str]):
        pricing_model (Union[Unset, PatchRegistryRegistriesRegistryIdEntriesEntryIdServicesServiceIdBodyPricingModel]):
        price_min (Union[None, Unset, int]):
        price_max (Union[None, Unset, int]):
        currency (Union[Unset, str]):
        unit (Union[Unset, str]):
        delivery_mode (Union[Unset, PatchRegistryRegistriesRegistryIdEntriesEntryIdServicesServiceIdBodyDeliveryMode]):
    ...
    pricing_model: (
        Unset | PatchRegistryRegistriesRegistryIdEntriesEntryIdServicesServiceIdBodyPricingModel
    ) = UNSET
    ...
    delivery_mode: (
        Unset | PatchRegistryRegistriesRegistryIdEntriesEntryIdServicesServiceIdBodyDeliveryMode
    ) = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_registry_registries_registry_id_entries_entry_id_services_service_id_body = cls(
            title=title,
        ...
        patch_registry_registries_registry_id_entries_entry_id_services_service_id_body.additional_properties = d
        return patch_registry_registries_registry_id_entries_entry_id_services_service_id_body
