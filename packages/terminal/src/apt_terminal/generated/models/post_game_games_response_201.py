...
if TYPE_CHECKING:
    from ..models.post_game_games_response_201_engine_config_type_1 import (
        PostGameGamesResponse201EngineConfigType1,
    )


T = TypeVar("T", bound="PostGameGamesResponse201")


@_attrs_define
class PostGameGamesResponse201:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
        ...
        engine (str):
        engine_config (Union['PostGameGamesResponse201EngineConfigType1', None, bool, float, list[Any], str]):
        character_names (str):
        status (str):
        event_log (str):
    ...
    engine: str
    engine_config: Union[
        "PostGameGamesResponse201EngineConfigType1", None, bool, float, list[Any], str
    ]
    character_names: str
    status: str
    event_log: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_engine_config(
            data: object,
        ) -> Union["PostGameGamesResponse201EngineConfigType1", None, bool, float, list[Any], str]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                engine_config_type_1 = PostGameGamesResponse201EngineConfigType1.from_dict(data)
        ...
        post_game_games_response_201 = cls(
            id=id,
        ...
        return post_game_games_response_201
