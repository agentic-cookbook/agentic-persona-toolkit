...
T = TypeVar("T", bound="PutContentCategoryEdgesIdResponse200")


@_attrs_define
class PutContentCategoryEdgesIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_content_category_edges_id_response_200 = cls(
            id=id,
        ...
        return put_content_category_edges_id_response_200
