...
T = TypeVar("T", bound="PostEcosystemEcosystemsResponse201")


@_attrs_define
class PostEcosystemEcosystemsResponse201:
    """
    Attributes:
        id (str):
        owner_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_ecosystem_ecosystems_response_201 = cls(
            id=id,
            owner_id=owner_id,
            slug=slug,
            name=name,
        ...
        return post_ecosystem_ecosystems_response_201
