...
T = TypeVar("T", bound="PostContentQueuesResponse201")


@_attrs_define
class PostContentQueuesResponse201:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_content_queues_response_201 = cls(
            id=id,
        ...
        return post_content_queues_response_201
