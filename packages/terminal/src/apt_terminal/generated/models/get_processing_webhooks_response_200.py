...
T = TypeVar("T", bound="GetProcessingWebhooksResponse200")


@_attrs_define
class GetProcessingWebhooksResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_processing_webhooks_response_200 = cls(
            endpoints=endpoints,
        )

        get_processing_webhooks_response_200.additional_properties = d
        return get_processing_webhooks_response_200
