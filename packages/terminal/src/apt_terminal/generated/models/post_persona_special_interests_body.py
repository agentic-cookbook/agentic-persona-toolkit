...
T = TypeVar("T", bound="PostPersonaSpecialInterestsBody")


@_attrs_define
class PostPersonaSpecialInterestsBody:
    """
    Attributes:
        persona_id (str):
        slug (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_persona_special_interests_body = cls(
        ...
        return post_persona_special_interests_body
