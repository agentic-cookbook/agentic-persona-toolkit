...
T = TypeVar("T", bound="PostIntegrationIntegrationCalendarEventsBody")


@_attrs_define
class PostIntegrationIntegrationCalendarEventsBody:
    """
    Attributes:
        title (str):
        source (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_integration_integration_calendar_events_body = cls(
            title=title,
            source=source,
        ...
        return post_integration_integration_calendar_events_body
