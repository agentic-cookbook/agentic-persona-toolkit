...
if TYPE_CHECKING:
    from ..models.post_content_queue_items_response_201_payload_type_1 import (
        PostContentQueueItemsResponse201PayloadType1,
    )


T = TypeVar("T", bound="PostContentQueueItemsResponse201")


@_attrs_define
class PostContentQueueItemsResponse201:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
        ...
        queue_id (str):
        payload (Union['PostContentQueueItemsResponse201PayloadType1', None, bool, float, list[Any], str]):
        status (str):
        enqueued_at (str):
    ...
    queue_id: str
    payload: Union[
        "PostContentQueueItemsResponse201PayloadType1", None, bool, float, list[Any], str
    ]
    status: str
    enqueued_at: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.payload, PostContentQueueItemsResponse201PayloadType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_payload(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                payload_type_1 = PostContentQueueItemsResponse201PayloadType1.from_dict(data)
        ...
        post_content_queue_items_response_201 = cls(
            id=id,
        ...
        return post_content_queue_items_response_201
