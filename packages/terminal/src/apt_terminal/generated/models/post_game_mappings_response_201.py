...
T = TypeVar("T", bound="PostGameMappingsResponse201")


@_attrs_define
class PostGameMappingsResponse201:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_game_mappings_response_201 = cls(
            id=id,
        ...
        return post_game_mappings_response_201
