...
T = TypeVar("T", bound="PostContentKeywordItemsResponse201")


@_attrs_define
class PostContentKeywordItemsResponse201:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_content_keyword_items_response_201 = cls(
            id=id,
        ...
        return post_content_keyword_items_response_201
