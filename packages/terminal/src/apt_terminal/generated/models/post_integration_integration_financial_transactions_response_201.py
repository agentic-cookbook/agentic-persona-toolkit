...
T = TypeVar("T", bound="PostIntegrationIntegrationFinancialTransactionsResponse201")


@_attrs_define
class PostIntegrationIntegrationFinancialTransactionsResponse201:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_integration_integration_financial_transactions_response_201 = cls(
            id=id,
        ...
        return post_integration_integration_financial_transactions_response_201
