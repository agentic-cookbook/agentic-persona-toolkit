...
T = TypeVar("T", bound="PutContentRelationshipsIdResponse200")


@_attrs_define
class PutContentRelationshipsIdResponse200:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_content_relationships_id_response_200 = cls(
            id=id,
        ...
        return put_content_relationships_id_response_200
