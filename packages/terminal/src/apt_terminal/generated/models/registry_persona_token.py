...
T = TypeVar("T", bound="RegistryPersonaToken")


@_attrs_define
class RegistryPersonaToken:
    """
    Attributes:
        id (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        registry_persona_token.additional_properties = d
        return registry_persona_token
