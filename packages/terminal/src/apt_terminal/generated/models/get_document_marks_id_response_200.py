...
T = TypeVar("T", bound="GetDocumentMarksIdResponse200")


@_attrs_define
class GetDocumentMarksIdResponse200:
    """
    Attributes:
        id (str):
        block_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_document_marks_id_response_200 = cls(
            id=id,
            block_id=block_id,
        ...
        return get_document_marks_id_response_200
