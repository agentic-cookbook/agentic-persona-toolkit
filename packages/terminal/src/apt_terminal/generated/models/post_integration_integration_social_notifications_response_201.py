...
T = TypeVar("T", bound="PostIntegrationIntegrationSocialNotificationsResponse201")


@_attrs_define
class PostIntegrationIntegrationSocialNotificationsResponse201:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_integration_integration_social_notifications_response_201 = cls(
            id=id,
        ...
        return post_integration_integration_social_notifications_response_201
