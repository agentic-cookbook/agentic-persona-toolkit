...
T = TypeVar("T", bound="IntegrationActionRequestType7")


@_attrs_define
class IntegrationActionRequestType7:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        integration_action_request_type_7 = cls(
        ...
        integration_action_request_type_7.additional_properties = d
        return integration_action_request_type_7
