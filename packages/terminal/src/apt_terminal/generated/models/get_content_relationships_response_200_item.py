...
T = TypeVar("T", bound="GetContentRelationshipsResponse200Item")


@_attrs_define
class GetContentRelationshipsResponse200Item:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_content_relationships_response_200_item = cls(
            id=id,
        ...
        return get_content_relationships_response_200_item
