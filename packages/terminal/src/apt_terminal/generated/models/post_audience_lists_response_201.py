...
T = TypeVar("T", bound="PostAudienceListsResponse201")


@_attrs_define
class PostAudienceListsResponse201:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_audience_lists_response_201 = cls(
            id=id,
        ...
        return post_audience_lists_response_201
