...
T = TypeVar("T", bound="PostDocumentMarksResponse201")


@_attrs_define
class PostDocumentMarksResponse201:
    """
    Attributes:
        id (str):
        block_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_document_marks_response_201 = cls(
            id=id,
            block_id=block_id,
        ...
        return post_document_marks_response_201
