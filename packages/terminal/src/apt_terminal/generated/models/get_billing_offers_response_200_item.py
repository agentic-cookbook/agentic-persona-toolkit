...
T = TypeVar("T", bound="GetBillingOffersResponse200Item")


@_attrs_define
class GetBillingOffersResponse200Item:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_billing_offers_response_200_item = cls(
            id=id,
        ...
        return get_billing_offers_response_200_item
