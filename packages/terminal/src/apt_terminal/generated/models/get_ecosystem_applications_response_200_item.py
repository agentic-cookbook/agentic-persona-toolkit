...
T = TypeVar("T", bound="GetEcosystemApplicationsResponse200Item")


@_attrs_define
class GetEcosystemApplicationsResponse200Item:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_ecosystem_applications_response_200_item = cls(
            id=id,
        ...
        return get_ecosystem_applications_response_200_item
