...
if TYPE_CHECKING:
    from ..models.get_game_definitions_response_200_item_data_type_0_type_1 import (
        GetGameDefinitionsResponse200ItemDataType0Type1,
    )


T = TypeVar("T", bound="GetGameDefinitionsResponse200Item")


@_attrs_define
class GetGameDefinitionsResponse200Item:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
        ...
        status (str):
        sort_order (int):
        data (Union['GetGameDefinitionsResponse200ItemDataType0Type1', None, bool, float, list[Any], str]):
        created_at (str):
        updated_at (str):
    ...
    sort_order: int
    data: Union[
        "GetGameDefinitionsResponse200ItemDataType0Type1", None, bool, float, list[Any], str
    ]
    created_at: str
    updated_at: str
    deleted_at: None | str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0_type_1 = GetGameDefinitionsResponse200ItemDataType0Type1.from_dict(data)
        ...
        get_game_definitions_response_200_item = cls(
            id=id,
        ...
        return get_game_definitions_response_200_item
