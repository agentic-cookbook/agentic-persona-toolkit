...
T = TypeVar("T", bound="PostIntegrationIntegrationBookmarksResponse201")


@_attrs_define
class PostIntegrationIntegrationBookmarksResponse201:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_integration_integration_bookmarks_response_201 = cls(
            id=id,
        ...
        return post_integration_integration_bookmarks_response_201
