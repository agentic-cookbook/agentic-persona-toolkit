...
T = TypeVar("T", bound="GetContentCategoryEdgesIdResponse200")


@_attrs_define
class GetContentCategoryEdgesIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_content_category_edges_id_response_200 = cls(
            id=id,
        ...
        return get_content_category_edges_id_response_200
