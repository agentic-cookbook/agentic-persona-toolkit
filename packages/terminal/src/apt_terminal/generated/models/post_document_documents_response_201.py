...
T = TypeVar("T", bound="PostDocumentDocumentsResponse201")


@_attrs_define
class PostDocumentDocumentsResponse201:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_document_documents_response_201 = cls(
            id=id,
        ...
        return post_document_documents_response_201
