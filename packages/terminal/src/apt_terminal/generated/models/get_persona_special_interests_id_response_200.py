...
T = TypeVar("T", bound="GetPersonaSpecialInterestsIdResponse200")


@_attrs_define
class GetPersonaSpecialInterestsIdResponse200:
    """
    Attributes:
        id (str):
        persona_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_persona_special_interests_id_response_200 = cls(
            id=id,
        ...
        return get_persona_special_interests_id_response_200
