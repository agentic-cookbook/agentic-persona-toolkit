...
from ..models.post_oauth_providers_response_201_auth_type import (
    PostOauthProvidersResponse201AuthType,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_oauth_providers_response_201_identity_mapping import (
        PostOauthProvidersResponse201IdentityMapping,
    )


T = TypeVar("T", bound="PostOauthProvidersResponse201")


@_attrs_define
class PostOauthProvidersResponse201:
    """
    Attributes:
        id (str):
        slug (str):
        name (str):
        auth_type (PostOauthProvidersResponse201AuthType):
        client_id (str):
        scopes (list[str]):
        identity_mapping (PostOauthProvidersResponse201IdentityMapping):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        auth_type = PostOauthProvidersResponse201AuthType(d.pop("authType"))

        client_id = d.pop("clientId")

        scopes = cast(list[str], d.pop("scopes"))

        identity_mapping = PostOauthProvidersResponse201IdentityMapping.from_dict(
        ...
        post_oauth_providers_response_201 = cls(
            id=id,
            slug=slug,
            name=name,
            auth_type=auth_type,
        ...
        post_oauth_providers_response_201.additional_properties = d
        return post_oauth_providers_response_201
