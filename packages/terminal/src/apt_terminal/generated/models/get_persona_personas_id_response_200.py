...
if TYPE_CHECKING:
    from ..models.get_persona_personas_id_response_200_canned_chat_type_0_type_1 import (
        GetPersonaPersonasIdResponse200CannedChatType0Type1,
    )
    from ..models.get_persona_personas_id_response_200_chat_status_type_0_type_1 import (
        GetPersonaPersonasIdResponse200ChatStatusType0Type1,
    )


T = TypeVar("T", bound="GetPersonaPersonasIdResponse200")


@_attrs_define
class GetPersonaPersonasIdResponse200:
    """
    Attributes:
        id (str):
        ...
        canned_chat (Union['GetPersonaPersonasIdResponse200CannedChatType0Type1', None, bool, float, list[Any], str]):
        chat_status (Union['GetPersonaPersonasIdResponse200ChatStatusType0Type1', None, bool, float, list[Any], str]):
        created_at (str):
        updated_at (str):
    ...
    examples: None | str
    canned_chat: Union[
        "GetPersonaPersonasIdResponse200CannedChatType0Type1", None, bool, float, list[Any], str
    ]
    chat_status: Union[
        "GetPersonaPersonasIdResponse200ChatStatusType0Type1", None, bool, float, list[Any], str
    ]
    created_at: str
    updated_at: str
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_canned_chat(
            ...
            try:
                ...
                canned_chat_type_0_type_1 = (
                    GetPersonaPersonasIdResponse200CannedChatType0Type1.from_dict(data)
                )
        ...
        def _parse_chat_status(
            ...
            try:
                ...
                chat_status_type_0_type_1 = (
                    GetPersonaPersonasIdResponse200ChatStatusType0Type1.from_dict(data)
                )
        ...
        get_persona_personas_id_response_200 = cls(
            id=id,
            user_id=user_id,
        ...
        return get_persona_personas_id_response_200
