...
T = TypeVar("T", bound="GetUsageRateLimitTiersIdResponse200")


@_attrs_define
class GetUsageRateLimitTiersIdResponse200:
    """
    Attributes:
        id (str):
        slug (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_usage_rate_limit_tiers_id_response_200 = cls(
            id=id,
            slug=slug,
            name=name,
        ...
        return get_usage_rate_limit_tiers_id_response_200
