...
T = TypeVar("T", bound="PutGameMappingsIdResponse200")


@_attrs_define
class PutGameMappingsIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_game_mappings_id_response_200 = cls(
            id=id,
        ...
        return put_game_mappings_id_response_200
