...
T = TypeVar("T", bound="GetContentCategoryEdgesResponse200Item")


@_attrs_define
class GetContentCategoryEdgesResponse200Item:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_content_category_edges_response_200_item = cls(
            id=id,
        ...
        return get_content_category_edges_response_200_item
