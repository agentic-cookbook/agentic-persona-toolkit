...
T = TypeVar("T", bound="PostDocumentVersionsResponse201")


@_attrs_define
class PostDocumentVersionsResponse201:
    """
    Attributes:
        id (str):
        document_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_document_versions_response_201 = cls(
            id=id,
        ...
        return post_document_versions_response_201
