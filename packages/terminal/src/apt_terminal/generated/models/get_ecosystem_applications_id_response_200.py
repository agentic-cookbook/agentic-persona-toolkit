...
T = TypeVar("T", bound="GetEcosystemApplicationsIdResponse200")


@_attrs_define
class GetEcosystemApplicationsIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_ecosystem_applications_id_response_200 = cls(
            id=id,
        ...
        return get_ecosystem_applications_id_response_200
