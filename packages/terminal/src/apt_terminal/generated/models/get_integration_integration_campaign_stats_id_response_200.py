...
if TYPE_CHECKING:
    from ..models.get_integration_integration_campaign_stats_id_response_200_raw_type_0_type_1 import (
        GetIntegrationIntegrationCampaignStatsIdResponse200RawType0Type1,
    )


T = TypeVar("T", bound="GetIntegrationIntegrationCampaignStatsIdResponse200")


@_attrs_define
class GetIntegrationIntegrationCampaignStatsIdResponse200:
    """
    Attributes:
        id (str):
        customer_id (str):
        ...
        raw (Union['GetIntegrationIntegrationCampaignStatsIdResponse200RawType0Type1', None, bool, float, list[Any],
            str]):
        is_deleted (bool):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.raw, GetIntegrationIntegrationCampaignStatsIdResponse200RawType0Type1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_raw(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                raw_type_0_type_1 = (
                    GetIntegrationIntegrationCampaignStatsIdResponse200RawType0Type1.from_dict(data)
                )
        ...
        get_integration_integration_campaign_stats_id_response_200 = cls(
            id=id,
        ...
        return get_integration_integration_campaign_stats_id_response_200
