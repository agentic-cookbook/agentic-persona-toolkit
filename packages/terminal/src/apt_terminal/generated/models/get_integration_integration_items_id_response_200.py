...
T = TypeVar("T", bound="GetIntegrationIntegrationItemsIdResponse200")


@_attrs_define
class GetIntegrationIntegrationItemsIdResponse200:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_integration_integration_items_id_response_200 = cls(
            id=id,
        ...
        return get_integration_integration_items_id_response_200
