...
T = TypeVar("T", bound="GetGameEffectsResponse200Item")


@_attrs_define
class GetGameEffectsResponse200Item:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_game_effects_response_200_item = cls(
            id=id,
        ...
        return get_game_effects_response_200_item
