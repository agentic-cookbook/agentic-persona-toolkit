...
T = TypeVar("T", bound="PutBillingOffersIdResponse200")


@_attrs_define
class PutBillingOffersIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_billing_offers_id_response_200 = cls(
            id=id,
        ...
        return put_billing_offers_id_response_200
