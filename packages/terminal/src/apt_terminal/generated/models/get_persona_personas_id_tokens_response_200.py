...
T = TypeVar("T", bound="GetPersonaPersonasIdTokensResponse200")


@_attrs_define
class GetPersonaPersonasIdTokensResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_persona_personas_id_tokens_response_200 = cls(
            tokens=tokens,
        )

        get_persona_personas_id_tokens_response_200.additional_properties = d
        return get_persona_personas_id_tokens_response_200
