...
T = TypeVar("T", bound="PatchOauthProvidersSlugResponse200IdentityMapping")


@_attrs_define
class PatchOauthProvidersSlugResponse200IdentityMapping:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_oauth_providers_slug_response_200_identity_mapping = cls(
        ...
        patch_oauth_providers_slug_response_200_identity_mapping.additional_properties = d
        return patch_oauth_providers_slug_response_200_identity_mapping
