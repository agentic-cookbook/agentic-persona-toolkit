...
if TYPE_CHECKING:
    from ..models.get_content_key_value_pairs_id_response_200_value_type_1 import (
...
class GetContentKeyValuePairsIdResponse200:
    ...
    key: str
    value: Union[
        "GetContentKeyValuePairsIdResponse200ValueType1", None, bool, float, list[Any], str
    ]
    created_at: str
    updated_at: str
    sync_version: int
