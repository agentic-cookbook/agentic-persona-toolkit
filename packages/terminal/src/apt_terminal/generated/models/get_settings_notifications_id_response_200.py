...
T = TypeVar("T", bound="GetSettingsNotificationsIdResponse200")


@_attrs_define
class GetSettingsNotificationsIdResponse200:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_settings_notifications_id_response_200 = cls(
            id=id,
        ...
        return get_settings_notifications_id_response_200
