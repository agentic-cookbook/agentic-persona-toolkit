...
T = TypeVar("T", bound="PostIntegrationIntegrationCalendarEventsResponse201")


@_attrs_define
class PostIntegrationIntegrationCalendarEventsResponse201:
    """
    Attributes:
        id (str):
        title (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_integration_integration_calendar_events_response_201 = cls(
            id=id,
            title=title,
            description=description,
        ...
        return post_integration_integration_calendar_events_response_201
