...
T = TypeVar("T", bound="PutPersonaMemoryFactsIdResponse200")


@_attrs_define
class PutPersonaMemoryFactsIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_persona_memory_facts_id_response_200 = cls(
            id=id,
        ...
        return put_persona_memory_facts_id_response_200
