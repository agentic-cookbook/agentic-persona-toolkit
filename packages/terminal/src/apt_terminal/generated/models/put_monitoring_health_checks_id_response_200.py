...
T = TypeVar("T", bound="PutMonitoringHealthChecksIdResponse200")


@_attrs_define
class PutMonitoringHealthChecksIdResponse200:
    """
    Attributes:
        id (str):
        endpoint_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_monitoring_health_checks_id_response_200 = cls(
            id=id,
        ...
        return put_monitoring_health_checks_id_response_200
