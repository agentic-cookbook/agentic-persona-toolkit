...
T = TypeVar("T", bound="GetContentLocationsResponse200Item")


@_attrs_define
class GetContentLocationsResponse200Item:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_content_locations_response_200_item = cls(
            id=id,
        ...
        return get_content_locations_response_200_item
