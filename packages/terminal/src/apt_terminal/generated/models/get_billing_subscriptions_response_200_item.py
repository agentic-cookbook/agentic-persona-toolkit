...
T = TypeVar("T", bound="GetBillingSubscriptionsResponse200Item")


@_attrs_define
class GetBillingSubscriptionsResponse200Item:
    """
    Attributes:
        id (str):
        user_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_billing_subscriptions_response_200_item = cls(
            id=id,
            user_id=user_id,
        ...
        return get_billing_subscriptions_response_200_item
