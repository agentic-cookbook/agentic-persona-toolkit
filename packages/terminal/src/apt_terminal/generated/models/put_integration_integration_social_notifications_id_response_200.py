...
T = TypeVar("T", bound="PutIntegrationIntegrationSocialNotificationsIdResponse200")


@_attrs_define
class PutIntegrationIntegrationSocialNotificationsIdResponse200:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_integration_integration_social_notifications_id_response_200 = cls(
            id=id,
        ...
        return put_integration_integration_social_notifications_id_response_200
