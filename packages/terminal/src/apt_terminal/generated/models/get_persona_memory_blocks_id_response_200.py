...
if TYPE_CHECKING:
    from ..models.get_persona_memory_blocks_id_response_200_content_type_1 import (
...
class GetPersonaMemoryBlocksIdResponse200:
    ...
    name: str
    content: Union[
        "GetPersonaMemoryBlocksIdResponse200ContentType1", None, bool, float, list[Any], str
    ]
    size_limit: None | int
    created_at: str
    updated_at: str
