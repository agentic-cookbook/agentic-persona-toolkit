...
T = TypeVar("T", bound="GetPersonaMemoryFactsResponse200Item")


@_attrs_define
class GetPersonaMemoryFactsResponse200Item:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_persona_memory_facts_response_200_item = cls(
            id=id,
        ...
        return get_persona_memory_facts_response_200_item
