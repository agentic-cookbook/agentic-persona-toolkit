...
T = TypeVar("T", bound="GetGameEffectsIdResponse200")


@_attrs_define
class GetGameEffectsIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_game_effects_id_response_200 = cls(
            id=id,
        ...
        return get_game_effects_id_response_200
