...
T = TypeVar("T", bound="PostUsageRateLimitTiersResponse201")


@_attrs_define
class PostUsageRateLimitTiersResponse201:
    """
    Attributes:
        id (str):
        slug (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_usage_rate_limit_tiers_response_201 = cls(
            id=id,
            slug=slug,
            name=name,
        ...
        return post_usage_rate_limit_tiers_response_201
