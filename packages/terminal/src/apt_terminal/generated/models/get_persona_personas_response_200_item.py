...
if TYPE_CHECKING:
    from ..models.get_persona_personas_response_200_item_canned_chat_type_0_type_1 import (
        GetPersonaPersonasResponse200ItemCannedChatType0Type1,
    )
    from ..models.get_persona_personas_response_200_item_chat_status_type_0_type_1 import (
...
class GetPersonaPersonasResponse200Item:
    ...
    Attributes:
        ...
        canned_chat (Union['GetPersonaPersonasResponse200ItemCannedChatType0Type1', None, bool, float, list[Any], str]):
        chat_status (Union['GetPersonaPersonasResponse200ItemChatStatusType0Type1', None, bool, float, list[Any], str]):
        created_at (str):
        updated_at (str):
    ...
    examples: None | str
    canned_chat: Union[
        "GetPersonaPersonasResponse200ItemCannedChatType0Type1", None, bool, float, list[Any], str
    ]
    chat_status: Union[
        "GetPersonaPersonasResponse200ItemChatStatusType0Type1", None, bool, float, list[Any], str
    ]
    created_at: str
    updated_at: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.canned_chat, GetPersonaPersonasResponse200ItemCannedChatType0Type1):
        ...
        if isinstance(self.chat_status, GetPersonaPersonasResponse200ItemChatStatusType0Type1):
        ...
        def _parse_canned_chat(
            ...
            try:
                ...
                canned_chat_type_0_type_1 = (
                    GetPersonaPersonasResponse200ItemCannedChatType0Type1.from_dict(data)
                )
        ...
        def _parse_chat_status(
            ...
            try:
                ...
                chat_status_type_0_type_1 = (
                    GetPersonaPersonasResponse200ItemChatStatusType0Type1.from_dict(data)
                )
