...
if TYPE_CHECKING:
    from ..models.put_game_definitions_id_response_200_data_type_0_type_1 import (
        PutGameDefinitionsIdResponse200DataType0Type1,
    )


T = TypeVar("T", bound="PutGameDefinitionsIdResponse200")


@_attrs_define
class PutGameDefinitionsIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
        ...
        status (str):
        sort_order (int):
        data (Union['PutGameDefinitionsIdResponse200DataType0Type1', None, bool, float, list[Any], str]):
        created_at (str):
        updated_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(
            ...
            "PutGameDefinitionsIdResponse200DataType0Type1", None, bool, float, list[Any], str
        ]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0_type_1 = PutGameDefinitionsIdResponse200DataType0Type1.from_dict(data)
        ...
        put_game_definitions_id_response_200 = cls(
            id=id,
        ...
        return put_game_definitions_id_response_200
