...
T = TypeVar("T", bound="PostContentCategoriesResponse201")


@_attrs_define
class PostContentCategoriesResponse201:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_content_categories_response_201 = cls(
            id=id,
        ...
        return post_content_categories_response_201
