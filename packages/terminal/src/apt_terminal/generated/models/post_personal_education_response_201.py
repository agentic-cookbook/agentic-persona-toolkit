...
T = TypeVar("T", bound="PostPersonalEducationResponse201")


@_attrs_define
class PostPersonalEducationResponse201:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_personal_education_response_201 = cls(
            id=id,
        ...
        return post_personal_education_response_201
