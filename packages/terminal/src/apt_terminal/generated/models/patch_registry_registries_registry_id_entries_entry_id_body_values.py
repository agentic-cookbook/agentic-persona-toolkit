...
T = TypeVar("T", bound="PatchRegistryRegistriesRegistryIdEntriesEntryIdBodyValues")


@_attrs_define
class PatchRegistryRegistriesRegistryIdEntriesEntryIdBodyValues:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        patch_registry_registries_registry_id_entries_entry_id_body_values = cls()

        patch_registry_registries_registry_id_entries_entry_id_body_values.additional_properties = d
        return patch_registry_registries_registry_id_entries_entry_id_body_values
