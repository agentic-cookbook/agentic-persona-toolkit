...
if TYPE_CHECKING:
    from ..models.get_bucket_bucket_types_id_response_200_metadata_type_0_type_1 import (
...
class GetBucketBucketTypesIdResponse200:
    ...
    ref_mode: str
    metadata: Union[
        "GetBucketBucketTypesIdResponse200MetadataType0Type1", None, bool, float, list[Any], str
    ]
    created_at: str
    updated_at: str
    deleted_at: None | str
        ...
        def _parse_metadata(
            ...
            try:
                ...
                metadata_type_0_type_1 = (
                    GetBucketBucketTypesIdResponse200MetadataType0Type1.from_dict(data)
                )
