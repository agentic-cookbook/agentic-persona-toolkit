...
T = TypeVar("T", bound="GetContentPollOptionsResponse200Item")


@_attrs_define
class GetContentPollOptionsResponse200Item:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_content_poll_options_response_200_item = cls(
            id=id,
        ...
        return get_content_poll_options_response_200_item
