...
T = TypeVar("T", bound="PostOauthProvidersResponse201IdentityMapping")


@_attrs_define
class PostOauthProvidersResponse201IdentityMapping:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_oauth_providers_response_201_identity_mapping = cls(
        ...
        post_oauth_providers_response_201_identity_mapping.additional_properties = d
        return post_oauth_providers_response_201_identity_mapping
