...
T = TypeVar("T", bound="GetIntegrationIntegrationPagesIdResponse200")


@_attrs_define
class GetIntegrationIntegrationPagesIdResponse200:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_integration_integration_pages_id_response_200 = cls(
            id=id,
        ...
        return get_integration_integration_pages_id_response_200
