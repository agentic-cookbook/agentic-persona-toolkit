...
T = TypeVar("T", bound="GetIntegrationIntegrationMediaItemsResponse200Item")


@_attrs_define
class GetIntegrationIntegrationMediaItemsResponse200Item:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_integration_integration_media_items_response_200_item = cls(
            id=id,
        ...
        return get_integration_integration_media_items_response_200_item
