...
T = TypeVar("T", bound="PostOauthClientsResponse201Client")


@_attrs_define
class PostOauthClientsResponse201Client:
    """
    Attributes:
        id (str):
        slug (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_oauth_clients_response_201_client = cls(
            id=id,
            slug=slug,
            name=name,
        ...
        post_oauth_clients_response_201_client.additional_properties = d
        return post_oauth_clients_response_201_client
