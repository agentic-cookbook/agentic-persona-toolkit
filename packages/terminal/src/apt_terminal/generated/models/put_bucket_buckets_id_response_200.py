...
if TYPE_CHECKING:
    from ..models.put_bucket_buckets_id_response_200_metadata_type_0_type_1 import (
...
class PutBucketBucketsIdResponse200:
    ...
    kind: str
    metadata: Union[
        "PutBucketBucketsIdResponse200MetadataType0Type1", None, bool, float, list[Any], str
    ]
    created_at: str
    updated_at: str
    deleted_at: None | str
        ...
        def _parse_metadata(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                metadata_type_0_type_1 = PutBucketBucketsIdResponse200MetadataType0Type1.from_dict(
                    data
                )
