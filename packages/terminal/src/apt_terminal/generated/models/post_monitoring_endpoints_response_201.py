...
T = TypeVar("T", bound="PostMonitoringEndpointsResponse201")


@_attrs_define
class PostMonitoringEndpointsResponse201:
    """
    Attributes:
        id (str):
        site_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_monitoring_endpoints_response_201 = cls(
            id=id,
            site_id=site_id,
            user_id=user_id,
        ...
        return post_monitoring_endpoints_response_201
