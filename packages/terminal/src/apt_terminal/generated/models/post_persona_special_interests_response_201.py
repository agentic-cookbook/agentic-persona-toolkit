...
T = TypeVar("T", bound="PostPersonaSpecialInterestsResponse201")


@_attrs_define
class PostPersonaSpecialInterestsResponse201:
    """
    Attributes:
        id (str):
        persona_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_persona_special_interests_response_201 = cls(
            id=id,
        ...
        return post_persona_special_interests_response_201
