...
T = TypeVar("T", bound="PostContentContactsResponse201")


@_attrs_define
class PostContentContactsResponse201:
    """
    Attributes:
        id (str):
        customer_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_content_contacts_response_201 = cls(
            id=id,
        ...
        return post_content_contacts_response_201
