...
T = TypeVar("T", bound="PutGamePlayersIdResponse200")


@_attrs_define
class PutGamePlayersIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_game_players_id_response_200 = cls(
            id=id,
        ...
        return put_game_players_id_response_200
