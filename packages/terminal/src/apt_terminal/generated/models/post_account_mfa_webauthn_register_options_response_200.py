...
if TYPE_CHECKING:
    from ..models.post_account_mfa_webauthn_register_options_response_200_options import (
...
class PostAccountMfaWebauthnRegisterOptionsResponse200:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        options = PostAccountMfaWebauthnRegisterOptionsResponse200Options.from_dict(
            d.pop("options")
        )
