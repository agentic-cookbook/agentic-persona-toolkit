...
T = TypeVar("T", bound="GetAudienceListsResponse200Item")


@_attrs_define
class GetAudienceListsResponse200Item:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_audience_lists_response_200_item = cls(
            id=id,
        ...
        return get_audience_lists_response_200_item
