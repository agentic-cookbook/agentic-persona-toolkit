...
T = TypeVar("T", bound="PutSystemAuditEventsIdResponse200")


@_attrs_define
class PutSystemAuditEventsIdResponse200:
    """
    Attributes:
        id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_system_audit_events_id_response_200 = cls(
            id=id,
        ...
        return put_system_audit_events_id_response_200
