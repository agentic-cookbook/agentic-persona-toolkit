...
if TYPE_CHECKING:
    from ..models.put_game_games_id_response_200_engine_config_type_1 import (
        PutGameGamesIdResponse200EngineConfigType1,
    )


T = TypeVar("T", bound="PutGameGamesIdResponse200")


@_attrs_define
class PutGameGamesIdResponse200:
    """
    Attributes:
        id (str):
        ecosystem_id (str):
        ...
        engine (str):
        engine_config (Union['PutGameGamesIdResponse200EngineConfigType1', None, bool, float, list[Any], str]):
        character_names (str):
        status (str):
        event_log (str):
    ...
    engine: str
    engine_config: Union[
        "PutGameGamesIdResponse200EngineConfigType1", None, bool, float, list[Any], str
    ]
    character_names: str
    status: str
    event_log: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.engine_config, PutGameGamesIdResponse200EngineConfigType1):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_engine_config(
            data: object,
        ) -> Union["PutGameGamesIdResponse200EngineConfigType1", None, bool, float, list[Any], str]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                engine_config_type_1 = PutGameGamesIdResponse200EngineConfigType1.from_dict(data)
        ...
        put_game_games_id_response_200 = cls(
            id=id,
        ...
        return put_game_games_id_response_200
