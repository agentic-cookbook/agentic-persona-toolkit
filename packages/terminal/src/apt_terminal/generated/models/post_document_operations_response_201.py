...
T = TypeVar("T", bound="PostDocumentOperationsResponse201")


@_attrs_define
class PostDocumentOperationsResponse201:
    """
    Attributes:
        id (str):
        document_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_document_operations_response_201 = cls(
            id=id,
        ...
        return post_document_operations_response_201
