...
/// `MobileThinkingIndicatorView` while someone is typing, and a single-line
...
public final class MobileChatViewController: UIViewController, ChatStateObserver, Themeable, UITextFieldDelegate {
    ...
    private func rebuildTranscript() {
        ...
        // `commandActivity` renders nothing here — only the thinking
        // indicator it usually drives remains.
